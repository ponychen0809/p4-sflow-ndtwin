    ...
    apply {
        ...
        if(ig_intr_md.ingress_port == 68){  //從recirc port進來，表示要做成flow sample packet
            ...
            // ********** 2 ********** //
                ...
                bit<32> flags_offset_2 = reg_flag_1.read(meta.sample_idx);
            ...
            // ********** 3 ********** //
                ...
                bit<32> flags_offset_3 = reg_flag_1.read(meta.sample_idx);
            ...
            // ********** 4 ********** //
                ...
                bit<32> flags_offset_4 = reg_flag_1.read(meta.sample_idx);
